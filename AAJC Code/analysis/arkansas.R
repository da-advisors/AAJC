...
ggsave(filename = "../../AAJC Vis/case_studies/arkansas/resp_by_tract_pop_scatter_NHPI_A_2020_SIZE_BENTON_2.png",
...
ggsave(filename = "../../AAJC Vis/case_studies/arkansas/resp_by_citizenship_NHPI_A_2020_SCATTER_BENTON_2.png",
